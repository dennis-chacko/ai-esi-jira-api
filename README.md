...
1) Clone the repository to your local machine ```git clone https://github.com/Signet-sd/esi-integration-platform.git```
2) Navigate to lambdas/Audit-Control-Tran-Exporter
